<?php
  ...
  if((isset($_POST['telefono'])) && (!empty($_POST['telefono']))){
    ...
    $telefono="El campo teléfono no puede estar vacío";
  }  
  ...
  if((isset($_POST['otros'])) && (!empty($_POST['otros']))){
      $otros=filter_var($_POST['otros'],FILTER_SANITIZE_STRING);
  }else{
    $otros="Has dejado este campo vacío";
  }
      ...
      <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
          <div class="container-fluid">
            <div class="navbar-header">
              <a class="navbar-brand" href="#">Rafa Montes</a>
            </div>
